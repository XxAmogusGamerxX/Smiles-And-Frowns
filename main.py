...
while(playing == True):
  ...
  if(firstTime == True):
    ...
    if(tutor == "Yes"):
      input("You will be prompted with a 5x5 board of smiley faces and you have to find the frowny face's coordinates before the timer runs out. The coordinates are in the (x,y or xy) form. Good Luck!\n")
